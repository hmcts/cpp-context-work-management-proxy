...
public class OverDueComparatorTest extends BaseSortingTest {

    @Test
    public void sortActivity() {

        final List<Task> tasks = createProcessInstanceTaskVariablesWithOverDueData();
    ...
    private List<Task> createProcessInstanceTaskVariablesWithOverDueData() {
        ...
        taskOne1.setDueDate(Date.from(now.minusDays(1).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskOne2.setDueDate(Date.from(now.minusDays(2).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskTwo1.setDueDate(Date.from(now.minusDays(3).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskTwo2.setDueDate(Date.from(now.minusDays(4).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskThree1.setDueDate(Date.from(now.minusDays(5).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskThree2.setDueDate(Date.from(now.minusDays(6).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskFour1.setDueDate(Date.from(now.minusDays(7).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskFour2.setDueDate(Date.from(now.minusDays(8).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskFive1.setDueDate(Date.from(now.minusDays(9).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskFive2.setDueDate(Date.from(now.minusDays(10).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskSix1.setDueDate(Date.from(now.minusDays(11).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskSix2.setDueDate(Date.from(now.minusDays(12).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskSeven1.setDueDate(Date.from(now.minusDays(13).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskSevenVariables1.put(IS_URGENT, Boolean.FALSE);
        ...
        taskSeven2.setDueDate(Date.from(now.minusDays(14).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskEight1.setDueDate(Date.from(now.minusDays(15).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskEight2.setDueDate(Date.from(now.minusDays(16).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskNine1.setDueDate(Date.from(now.minusDays(17).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskNine2.setDueDate(Date.from(now.minusDays(18).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskTen1.setDueDate(Date.from(now.minusDays(19).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskTen2.setDueDate(Date.from(now.minusDays(20).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskEleven1.setDueDate(Date.from(now.plusDays(1).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        ...
        taskEleven2.setDueDate(Date.from(now.plusDays(2).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
